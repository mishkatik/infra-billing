...
export const common = {
  en: {
    common: {
      ...
      iconUseFavicon: 'Empty',
      iconClear: 'Clear custom icon',
      iconBg: 'Background color',
      iconBgCustom: 'Custom color',
    },
    app: {
      brand: 'Infra Billing',
      singleUser: 'root',
    ...
    build: {
      ...
      copied: 'Copied',
      upToDate: 'Up to date',
      updateAvailable: 'v{{version}} is out',
  ...
  ru: {
    common: {
      ...
      iconUseFavicon: 'Empty',
      iconClear: 'Сбросить свою иконку',
      iconBg: 'Цвет фона',
      iconBgCustom: 'Свой цвет',
    },
    app: {
      brand: 'Infra Billing',
      singleUser: 'root',
    ...
    build: {
      ...
      updateAvailable: 'Вышла v{{version}}',
      devBuild: 'Сборка для разработки',
      checkUnavailable: 'Проверка обновлений недоступна',
