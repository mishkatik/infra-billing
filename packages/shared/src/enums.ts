...
/** Connector kinds. API-backed: timeweb, hetzner, hostkey, netcup, hostbill, billmgr, selectel, 4vps, netlen, beget, porkbun, vultr, linode, aeza, vibehost, vdsina, cloudflare, stormwall, yandex, doubleservers. manual = no sync. */
